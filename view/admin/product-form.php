                ...
                <div class="col-sm-5">
                    <form action="<?php echo $action ?>" method="post">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="<?php echo $product->title ?>" type="text" name="title">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" value="<?php echo $product->price ?>" type="text" name="price">
                        </div>
                        <div class="form-group">
                        ...
                        <a   class="float-right btn btn-outline-secondary" href="<?php echo url('/admin/products') ?>" class="btn btn-primary my-2">Back</a>
                    </form>
                </div>
            </section>
        </div>
